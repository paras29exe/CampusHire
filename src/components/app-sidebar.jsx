          ...
          <SidebarGroup>
            <SidebarMenu>
              {roleItems.map((item, index) => (
                ...
                item.subItems ? (
                  <Collapsible key={index} defaultOpen={true} open={open && collapsibleOpen} onOpenChange={setCollapsibleOpen} className="group/collapsible ">
                    <CollapsibleTrigger asChild>
                      <SidebarMenuButton onClick={() => !open && setOpen(true)} tooltip={item.title} className={' text-gray-700 text-base font-semibold'}>
                        {item.icon}
