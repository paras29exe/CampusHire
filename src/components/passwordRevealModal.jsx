  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogTitle className="text-red-600">User has been Added to system.</DialogTitle>
        <DialogTitle className="text-red-600">Here is Password generated by the System</DialogTitle>
